...
const CreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!title.trim() || validMovies.length === 0) {
      toast.error("Please provide a List Title and at least one Movie entry.");
      return;
    }
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="form-control mb-4 p-4 border border-base-content/20 rounded-lg">
                  <label className="label">
                    <span className="label-text text-lg font-bold">Movies List (Ranked Entries)</span>
                  </label>
                ...
                <div className="form-control mb-4">
                  <label className="label">
                    <span className="label-text">Extra Notes (Optional)</span>
                  </label>
                  <textarea
                    placeholder="Add optional notes about the list or movies."
